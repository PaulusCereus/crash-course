...
def main():
    ...
    Запрашивает у пользователя название города, получает данные о погоде, 
    извлекает ключевую информацию и отображает ее в виде таблицы.
    
    Если запрос к API не удался, выводится сообщение об ошибке.
    """
    ...
    # Если данные успешно получены, извлекаем информацию о погоде и выводим таблицу
    if data:
        # Извлекаем ключевые данные о погоде
        weather_info = extract_weather_info(data)

        # Выводим таблицу с информацией о погоде
        print(get_weather_info_table(weather_info=weather_info))
    else:
        # Если данные не были получены, выводим ошибку
        print("Не удалось получить данные от API.")

if __name__ == "__main__":
    # Запускаем основную функцию программы, если скрипт выполняется как основной
    main()
